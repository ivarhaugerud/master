...
plt.savefig("../../oppgave/figures/Pe0_compare.pdf")
plt.show()
...
plt.legend(loc="best", fontsize=12)
#plt.yscale("log")
plt.savefig("../../oppgave/figures/Pe0_frac_difference_n0.pdf")
plt.show()
...
plt.legend(loc="best", fontsize=12)
plt.yscale("log")
plt.savefig("../../oppgave/figures/Pe0_frac_rel_difference.pdf")
plt.show()