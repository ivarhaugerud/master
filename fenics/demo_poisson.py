...
def boundary(x):
	if x[1] < 0.3 or x[1] > 0.7:
		return x[0] < DOLFIN_EPS or x[0] > 1 - DOLFIN_EPS
	else:
		return x[0] < 0.2 or x[0] > 0.8 - DOLFIN_EPS
...
plt.show()
"""
#fenics@8a7f45402fb9:~/demo/python/documented/poisson$ python3 demo_poisson.py 
#Solving linear variational problem.
#The webagg server could not be started because an available port could not be found
#fenics@8a7f45402fb9:~/demo/python/documented/poisson$ 
